...
bindFormspreeForm('waitlistForm', 'waitlistNote', 'Merci ! Tu fais partie du mouvement. 🍋');
bindFormspreeForm('contactForm', 'contactNote', 'Merci, votre message est bien parti !');

// ============================================================
// MODULE BOUTIQUE — Shopify
// ============================================================
// La boutique n'est pas gérée en JavaScript : le code fourni par Shopify
// (Buy Button ou autre extrait d'achat) se colle directement dans
// index.html, à l'intérieur de la section "Achat" (#shopify-buy-button).
// Voir README.md pour le détail des étapes.
// ============================================================
